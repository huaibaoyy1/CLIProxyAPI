...
var zhStrings = map[string]string{
	...
	// ── Usage ──
	"usage_title":              "📈 使用统计",
	"usage_help":               " [r] 刷新 • [p/n, ←/→] 翻页 • [[/]] 调整每页数量 • [↑↓] 滚动",
	...
	"usage_page":               "页码",
	"usage_page_size":          "每页",
	"usage_total_items":        "总条数",
	"usage_request_details":    "请求明细",
	"usage_no_request_details": "  当前页没有请求明细",
	"usage_request_time":       "时间",
	"usage_request_api":        "API",
	"usage_request_model":      "模型",
	"usage_request_status":     "状态",
	"usage_request_latency":    "耗时",
	"usage_request_tokens":     "Tokens",
	"usage_request_source":     "来源",
	"usage_request_auth":       "认证",
	"usage_request_ok":         "成功",
	"usage_request_failed":     "失败",
...
var enStrings = map[string]string{
	...
	"usage_help":               " [r] Refresh • [p/n, ←/→] Page • [[/]] Adjust page size • [↑↓] Scroll",
	...
	"usage_page":               "Page",
	"usage_page_size":          "Page Size",
	"usage_total_items":        "Total",
	"usage_request_details":    "Request Details",
	"usage_no_request_details": "  No request details on this page",
	"usage_request_time":       "Time",
	"usage_request_api":        "API",
	"usage_request_model":      "Model",
	"usage_request_status":     "Status",
	"usage_request_latency":    "Latency",
	"usage_request_tokens":     "Tokens",
	"usage_request_source":     "Source",
	"usage_request_auth":       "Auth",
	"usage_request_ok":         "OK",
	"usage_request_failed":     "Failed",
